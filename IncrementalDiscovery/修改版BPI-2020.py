...
data = [['BPI2020-Algorithm', 'Time', 'Memory', 'Precision', 'Fitness', 'F-value']]
...
def alpha_flow():
    ...
    log_folder = "D:\\BPI-Month\\BPIC_2020\\Adding_Logs_For_Traditional_Discovery"
    logs = []
...
def IPDF_alpha_flow():
    ...
    start_mem = show_info()  # 开始内存
    start = time.time()  # 开始时间
    log_folder = "D:\\BPI-Month\\BPIC_2020"
    logs = []
    dfg1 = None
    ...
    log = xes_importer.apply(
        os.path.join("D:\BPI-Month\BPIC_2020", "Adding_Logs_For_Traditional_Discovery", "20For1-5.xes"))
