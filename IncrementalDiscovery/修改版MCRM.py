...
data = [['MCRM-Algorithm', 'Time', 'Memory', 'Precision', 'Fitness', 'F-value']]
...
def alpha_flow():
    ...
    log_folder = "D:\\BPI-Month\\MCRM\\Adding_Logs_For_Traditional_Discovery"
    logs = []
...
def IPDF_alpha_flow():
    ...
    log = xes_importer.apply(
        os.path.join("D:\BPI-Month\MCRM", "Adding_Logs_For_Traditional_Discovery", "9For1-11.xes"))
