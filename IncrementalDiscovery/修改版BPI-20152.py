...
data = [['BPI20152-Algorithm', 'Time', 'Memory', 'Precision', 'Fitness', 'F-value']]
...
def alpha_flow():
    ...
    log_folder = "D:\\BPI-Month\\BPIC_2015_2\\Adding_Logs_For_Traditional_Discovery"
    logs = []
...
def IPDF_alpha_flow():
    ...
    start_mem = show_info()  # 开始内存
    start = time.time()  # 开始时间
    log_folder = "D:\\BPI-Month\\BPIC_2015_2"
    logs = []
    dfg1 = None
    ...
    log = xes_importer.apply(
        os.path.join("D:\BPI-Month\BPIC_2015_2", "Adding_Logs_For_Traditional_Discovery", "15For11-3.xes"))
