...
data = [['BPIC2017-Algorithm', 'Time', 'Memory', 'Precision', 'Fitness', 'F-value']]
...
def alpha_flow():
    ...
    log_folder = "D:\\BPI-Month\\BPIC_2017\\Adding_Logs_For_Traditional_Discovery"
    logs = []
...
def IPDF_alpha_flow():
    ...
    start_mem = show_info()  # 开始内存
    start = time.time()  # 开始时间
    log_folder = "D:\\BPI-Month\\BPIC_2017"
    logs = []
    dfg1 = None
    ...
    # pn_visualizer.view(gviz)
    # end = time.time()  # 结束时间
    # end_mem = show_info()  # 结束内存f
    # print("程序运行时间：%.2f秒" % (end - start))  # 27.41
    # print(f'一共占用{end_mem - start_mem}MB')  # 467
    # log = xes_importer.apply(
    #     os.path.join("D:\BPI-Month\BPIC_2017", "Adding_Logs_For_Traditional_Discovery", "17For1-2.xes"))
